...
function finnanceForm()
	  ...
	  $id=$this->uri->segment(3);//$this->session->userdata('id');//$this->uri->segment(4);
	   if($this->session->userdata('id'))
			   {
				 				   $data['pages'] = $this->users->listAccount_1('	accounts INNER JOIN drivers ON driverId=acc_driver LEFT JOIN acc_coment as a ON accounts.acc_com_id=a.acc_com_id ');	
	   ...
	   if($this->session->userdata('id'))
			   {
				   ...
				   $data['pages'] = $this->users->financeList();//tblLIst('	accounts INNER JOIN drivers ON driverId=acc_driver');	
...
function get_comment()
{
  ...
  //**********************************//
    ...
    {
        $id=$this->uri->segment(3); 
         $data['balance']=$this->users->balance_detail();//tblLIst('accounts INNER JOIN drivers ON driverId=acc_driver','acc_driver',$id);
