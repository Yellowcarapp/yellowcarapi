	  ...
	  if($this->session->userdata('id'))
			   {   
						  ...
						  if($pageid) //update
						   ...
						   redirect(site_url('admin/Category/CategoryList')); 
	  ...
	  if($this->session->userdata('id'))
			   {   
						  ...
						  if($pageid) //update
						   ...
						   redirect(site_url('admin/Category/AllFoodType')); 
	  ...
	  if($this->session->userdata('id'))
			   {   
						  ...
						  if($pageid) //update
						   ...
						   redirect(site_url('admin/Category/CuisineList')); 
        ...
        if($this->session->userdata('id'))
			   {   
						  ...
						  if($pageid) //update
						   ...
						   redirect(site_url('admin/Category/AllAddons')); 
