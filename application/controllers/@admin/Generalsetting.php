		...
		{			  
						 $data =  array('brandName_ar' => $brandName_ar
						  ...
						  if($pageid) //update
						   ...
						   redirect(base_url('admin/generalsetting/AllBrands')); 
	...
	if( $this->session->userdata('id') &&  $this->session->userdata('id') !="")
	{
						 $data =  array('modelTitle_ar' => $modelTitle_ar
						  ...
						  if($pageid) //update
						   ...
						   redirect(base_url('admin/generalsetting/AllModel')); 
		...
		{			  
						 $data =  array('typeName_ar' => $typeName_ar
						  ...
						  if($pageid) //update
						   ...
						   redirect(base_url('admin/generalsetting/AllTripType')); 
		...
		{			  
						 $data =  array('levelName_ar' => $levelName_ar
						  ...
						  if($pageid) //update
						   ...
						   redirect(base_url('admin/generalsetting/AllLevel')); 
	...
	{ 
						 $data =  array('packageName_ar' => $packageName_ar 
						  ...
						  if($pageid) //update
						   ...
						   redirect(base_url('admin/generalsetting/Allpackage')); 
	...
	{ 
						 ...
						 ,'timeZone'=>$timeZone
						  ...
						  if($pageid) //update
						   ...
						   redirect(base_url('admin/generalsetting/AllCountry')); 
	...
	{ 
						 $data =  array('cityName_ar' => $cityName_ar 
						  ...
						  if($pageid) //update
						   ...
						   redirect(base_url('admin/generalsetting/AllCity')); 
	...
	{ 
						 $data =  array('placeName_ar' => $placeName_ar 
						  ...
						  if($pageid) //update
						   ...
						   redirect(base_url('admin/generalsetting/Allplaces')); 
	...
	{ 
						 $data =  array('start_date' => date("Y-m-d",strtotime($startDate)) 
						  ...
						  if($pageid) //update
						   ...
						   redirect(base_url('admin/generalsetting/AdvertiseList')); 
