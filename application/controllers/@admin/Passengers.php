...
$this->session->set_flashdata('success', '1');
									 ...
									 redirect(site_url('admin/Passengers/profile/saved')); 
									 } else {
									 	 redirect(site_url('admin/Passengers/memberList')); 
									 }
													  ...
													  redirect(site_url('admin/Passengers/Form/'.$id));
									  }
...
function memberList()
     {
 	 ...
 	 //################Padging###############//	
						...
						$config['num_links'] = 10;
						$config['base_url'] = site_url('admin/Users/memberList');
