		...
		<div class="with-padding">
			...
			<table class="table responsive-table" id="sorting-advanced">
				...
				<thead>
					<tr>
						<th scope="col">ID</th>
						<th scope="col" width="30%" >Page Name</th>
...
<a href="<?=site_url('admin/Category/FeaturePagesForm/'.$pages['id']); ?>" class="button icon-pencil">Edit</a>
 <a href="<?=site_url('admin/Category/DeleteFeaturePages/'.$pages['id']); ?>"   class="button icon-trash with-tooltip confirm" title="Delete"></a>
