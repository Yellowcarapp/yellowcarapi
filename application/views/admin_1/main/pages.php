...
<div class="tabs-content">
	...
	<form action="<?=site_url('admin/Pages/SavePages/'.$page_id); ?>" method="post" id="settingForm">
        <div id="alerts" class="with-padding">
            ...
            <div id="Arabic" class="with-padding">
                 <?php $this->load->view('admin/main/body_pages_ar'); ?>    
            </div>
            ...
            <div id="Options" class="with-padding">
                <?php //$this->load->view('admin/main/body_pages_options'); ?>    
            </div>

			<center>		
            	<div class="button-height"><button type="submit" class="button blue-gradient">حفــظ</button></div> 
            </center>
    </form>
</div>
...
$(document).ready(function() {	
	 $("form").submit(function() {
         ...
         if( $("#title_ar").val()=="" || $("#description_ar").val()=="" || $("#keyword_ar").val()=="" ) { 												
