...
<div class="tabs-content">
	...
	<form action="<?=site_url('admin/Page/SaveAdvs'); ?>" method="post" id="settingForm">
        <div id="alerts" class="with-padding">
            ...
            <div id="Arabic" class="with-padding">
                 <?php $this->load->view('admin/main/advs_pages_ar'); ?>    
            </div>
			...
			<center>		
            	<div class="button-height"><button type="submit" class="button blue-gradient">حفظ</button></div> 
            </center>
    </form>
</div>
...
*/
	...
	var editor = CKEDITOR.replace( 'home_welcome',
				{
