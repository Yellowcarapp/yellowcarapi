...
<div class="tabs-content">
	...
	<form action="<?=site_url('admin/Page/SaveThemePage'); ?>" method="post" id="settingForm">
        <div id="alerts" class="with-padding">
                    <?php if($resultNotification==1) {  ?> 
                        ...
                        <a class="close" title="Hide message" href="#">✕</a>
                            تم حفظ اعدادت الطفحة الرئيسية بنجاح
                        </p>
                   ...
                   <p class="message icon-speech red-gradient small-margin-bottom"  id="validatSubDiv" style="display:none;">
                      <a class="close" title="Hide message" href="#">✕</a>
                            هناك حقول ضروريه يجب ادخالها
                    </p>  
              </div>                         

           <!-- <div id="Arabic" class="with-padding">
                 <?php //$this->load->view('admin/main/home_page_ar'); ?>    
            </div>-->

            <!--<div id="English" >-->
                <?php $this->load->view('admin/main/Theme_page_en'); ?>    
            <!--</div>-->
            ...
            <div id="MapDiv" class="with-padding">
                <?php //$this->load->view('admin/main/body_setting_map'); ?>    
            </div>
...
*/
	...
	/*var editor = CKEDITOR.replace( 'home_welcome_ar','keywords_ar','desc_ar',
				{
    ...
    */
	...
	var editor = CKEDITOR.replace( 'home_welcome_en','keywords_en','desc_en',
				{
					// Defines a simpler toolbar to be used in this sample.
					// Note that we have added out "MyButton" button here.
					toolbar : [ [ 'Source', '-', 'Bold', 'Italic', 'Underline', 'Strike','-','Link', '-', 'MyButton' ] ,['JustifyLeft','JustifyCenter','JustifyRight','JustifyBlock']]
...
var editor = CKEDITOR.replace( 'keywords_ar',
				{
					// Defines a simpler toolbar to be used in this sample.
					// Note that we have added out "MyButton" button here.
					toolbar : [ [ 'Source', '-', 'Bold', 'Italic', 'Underline', 'Strike','-','Link', '-', 'MyButton' ] ,['JustifyLeft','JustifyCenter','JustifyRight','JustifyBlock']]
...
var editor = CKEDITOR.replace( 'desc_ar',
				{
					// Defines a simpler toolbar to be used in this sample.
					// Note that we have added out "MyButton" button here.
					toolbar : [ [ 'Source', '-', 'Bold', 'Italic', 'Underline', 'Strike','-','Link', '-', 'MyButton' ] ,['JustifyLeft','JustifyCenter','JustifyRight','JustifyBlock']]
...
var editor = CKEDITOR.replace( 'keywords_en',
				{
					// Defines a simpler toolbar to be used in this sample.
					// Note that we have added out "MyButton" button here.
					toolbar : [ [ 'Source', '-', 'Bold', 'Italic', 'Underline', 'Strike','-','Link', '-', 'MyButton' ] ,['JustifyLeft','JustifyCenter','JustifyRight','JustifyBlock']]
...
var editor = CKEDITOR.replace( 'desc_en',
				{
					// Defines a simpler toolbar to be used in this sample.
					// Note that we have added out "MyButton" button here.
					toolbar : [ [ 'Source', '-', 'Bold', 'Italic', 'Underline', 'Strike','-','Link', '-', 'MyButton' ] ,['JustifyLeft','JustifyCenter','JustifyRight','JustifyBlock']]
