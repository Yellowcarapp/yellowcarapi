...
<?php if(isset($Lates_p['id']) && $Lates_p['id']!='' && $Lates_p['id']>0) { ?> 
 <tr>
                     ...
                     <a class="tip_north" original-title="Edit" href="<?=site_url('admin/page/PageForm/'.$Lates_p['id']); ?>">C</a> 
                    <?php if($Lates_p['fixed_page']==0) { ?>  
                     <a class="tip_north" original-title="Delete"  onclick="return deletecheckedLatest('Are you sure you want to delete !!','<?=site_url('admin/page/DeletePage/'.$Lates_p['id']); ?>');" href="#">X</a>
                   <?php } ?>
...
<tr>
                     ...
                     <a class="tip_north" original-title="Edit" href="<?=site_url('admin/events/Form/'.$Lates_N['n_cat_type'].'/'.$Lates_N['id']); ?>">C</a> 
                    
                     <a class="tip_north" original-title="Delete"  onclick="return deletecheckedLatest('Are you sure you want to delete !!','<?=site_url('admin/events/delete/'.$Lates_N['n_cat_type'].'/'.$Lates_N['id']); ?>');" href="#">X</a>
...
<tr>
                     ...
                     <a class="tip_north" original-title="Edit" href="<?=site_url('admin/projects/Form/'.$Lates_projects['id']); ?>">C</a> 
                      
                     <a class="tip_north" original-title="Delete"  onclick="return deletechecked('Are you sure you want to delete <?=$Lates_projects['title_en'] ?> !!','<?=site_url('admin/projects/delete/'.$Lates_projects['id']); ?>');" href="#">X</a>
