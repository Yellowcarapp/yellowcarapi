                 ...
                 <div class="col-sm-4">
                    ...
                    <div class="col-sm-9">
                        <select id="levelId" class="form-control">
                            ...
                            <option value="<?php echo $level->levelId?>"><?php echo $level->levelName.'_'.lang('db')?></option>
                            <? endforeach;?>
                            <?php endif?>
                      </select>
                    </div>
...
<script>
  function CreateDriverElement(Obj)
  {
    ...
    function GetAllDrivers()
    {
        ...
        $.ajax({
            ...
            +'&levelId='+levelId+'&networkId=<?=$this->session->userdata('network');?>',
    ...
    function CreateMap(position)
    {
        ...
        var Map_Options={center: loc,zoom: 11,mapTypeId: google.maps.MapTypeId.ROADMAP};
	...
	$('.driver_trip').css({"height":tabs_div + "px"} );
	...
	function GetTrips()
  {
      ...
      Trips_Html='';
      $.ajax({
            url:ADMINAPI+'/trips/failed?networkId=<?=$this->session->userdata('network');?>',
            success:function(data){
