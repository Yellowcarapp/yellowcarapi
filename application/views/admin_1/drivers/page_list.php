                    ...
                    <?php $n=0;foreach($pages as $pages){$n++; ?>    
                      ...
                      <? if($pages['driverActivation']==0){ echo lang('new') .'!'; } else echo lang('Active');?>
                        ...
                        <td><div class="timeline-footer">
                          <a class="btn btn-primary btn-xs" href="<?=base_url('admin/drivers/driverForm/'.$pages['driverId']); ?>"> 
                          <i class="fa fa-pencil"></i> <?=lang('Edit')?></a>
                         <a class="btn btn-danger btn-xs jConfirmTwo" href="<?=base_url('admin/drivers/DeleteDriver/'.$pages['driverId']); ?>" >
                          <i class="fa fa-trash"></i> <?=lang('Delete')?></a>
                            <a class="btn btn-primary btn-xs" href="<?=base_url('admin/drivers/driverComment/'.$pages['driverId']); ?>"> 
