            ...
            <div class="col-xs-12">
              ...
              <div class="box">
                <div class="box-header">
                  ...
                  <li class=""><a href="<?=base_url('admin/finnance/finnanceForm')?>"  aria-expanded="false"><?=lang('Add_finnance')?></a></li>
                </ul>
                      ...
                      <tr>
                       ...
                       <td><?=$pages['driverFName'].' '.$pages['driverLName'];?></td>
                        ...
                        <td><div class="timeline-footer">
                          ...
                          <a class="btn btn-primary btn-xs" href="<?=base_url('admin/finnance/finnanceForm/'.$pages['acc_id']); ?>"> 
                          <i class="fa fa-pencil"></i> <?=lang('Edit')?></a>
                            
                         <a class="btn btn-danger btn-xs jConfirmTwo" href="<?=base_url('admin/finnance/delete/'.$pages['acc_id']); ?>" >
