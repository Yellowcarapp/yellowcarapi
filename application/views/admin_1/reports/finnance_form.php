          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <div class="box box-warning">
                ...
                <div class="box-body">
<form role="form" action="<?= site_url('admin/Reports/printFPdfReport') ?>" method="post" name="formID" class="formID" id="formID">
...
<script>
  $().ready(function(){
    ...
    extractReport=function()
    {
        ...
        if(exportType==0)
            {
                var url='<?= site_url('admin/reports/printFReport') ?>';
                var div='reportDiv';
            }else if(exportType==1)
                {
                    var url='<?= site_url('admin/Reports/printFPdfReport') ?>';
                    var div=''; 
                }
        else if(exportType==2)
                {
                    var url='<?= site_url('admin/Reports/printFChartReport') ?>';
