          ...
          <div class="row">
            <div class="col-md-12">
             <div class="box box-warning">
                ...
                <div class="box-body">
 <form action="<?=site_url('admin/Cards/SaveCard')?>" method="post" id="settingForm">
                  ...
                  <table id="example1" class="table table-bordered table-striped">
                   ...
                   foreach($pages as $pages){
                      ...
                      <tr>
                        ...
                        <!--  <a class="btn btn-primary btn-xs" href="<?=base_url('admin/cards/cardsForm/'.$pages['cardId']); ?>"> 
                          <i class="fa fa-pencil"></i> <?=lang('Edit')?></a>-->
                           
                            <? if($pages['cardUsed']==0) {?>
                         <a class="btn btn-danger btn-xs jConfirmTwo" href="<?=base_url('admin/cards/Deletecard/'.$pages['cardId']); ?>" >
...
console.log(response)
            ...
            $('#retSpan').load('<?=site_url('admin/Cards/saveFile')?>',{file:fileName})
