          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <div class="box box-warning">
                ...
                <div class="box-body">
<form role="form" action="<?=site_url('admin/Users/Save')?>" method="post" name="formID" class="formID" id="formID">
...
<?php } ?>    
     ...
     <div class="form-group">
                     ...
                     <label class="full_width"><?=lang('privillage')?></label>  
                             <?php if(isset($page['priv'])) $arr=explode(',',$page['priv']) ; else $arr=array();
                             //19,2,14,17,18
                         if($network==-1) $count=20;else $count=6;
                            ?>
