					...
					<tr>
						...
						<td class="low-padding align-center">
                        	<span class="button-group compact"> 
                        	   <a href="<?=site_url('admin/Members/PackageForm/'.$pages['id']); ?>" class="button icon-pencil">Edit</a>
  
								<a href="<?=site_url('admin/Members/DeletePackage/'.$pages['id']); ?>"   class="button icon-trash with-tooltip confirm" title="Delete"></a>
 							</span>
                      </td>
