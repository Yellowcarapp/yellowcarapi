            ...
            <div class="col-xs-12">
              ...
              <div class="box">
                ...
                <ul class="nav nav-tabs pull-right">
                  <li class=""><a href="<?=base_url('admin/generalsetting/CityForm')?>" aria-expanded="false"><?=lang('Add_City')?></a></li>
                </ul>
                    ...
                    <?php $m=0;foreach($pages as $pages){ $m++;
                      ...
                      <tr>
                        ...
                        <td><div class="timeline-footer">
                          <a class="btn btn-primary btn-xs" href="<?=base_url('admin/generalsetting/CityForm/'.$pages['cityId']); ?>"> 
                          <i class="fa fa-pencil"></i> <?=lang('Edit')?></a>
                         <a class="btn btn-danger btn-xs jConfirmTwo" href="<?=base_url('admin/generalsetting/DeleteCity/'.$pages['cityId'].'/'.$pages['cityStatus']); ?>" >
                          <i class="fa fa-trash"></i> <?=$title?></a>
                        </div>
                       </td>
                          
                        <td><div class="timeline-footer">
                         <a class="btn btn-large btn-primary" href="<?=base_url('admin/generalsetting/Allplaces/'.$pages['cityId'])?>">
                      <?=lang('places')?>
                        </a>
                        </div>
                       </td>  
