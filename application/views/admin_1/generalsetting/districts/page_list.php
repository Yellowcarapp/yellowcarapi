            ...
            <div class="col-xs-12">
              ...
              <div class="box">
                ...
                <ul class="nav nav-tabs pull-right">
                  <li class=""><a href="<?=base_url('admin/generalsetting/placeForm')?>" aria-expanded="false"><?=lang('Add_place')?></a></li>
                </ul>
                    ...
                    <?php $m=0;foreach($pages as $pages){$m++; 
                      ...
                      <tr>
                        ...
                        <td><div class="timeline-footer">
                          <a class="btn btn-primary btn-xs" href="<?=base_url('admin/generalsetting/placeForm/'.$pages['placeId']); ?>"> 
                          <i class="fa fa-pencil"></i> <?=lang('Edit')?></a>
                         <a class="btn btn-danger btn-xs jConfirmTwo" href="<?=base_url('admin/generalsetting/Deleteplace/'.$pages['placeId']); ?>" >
