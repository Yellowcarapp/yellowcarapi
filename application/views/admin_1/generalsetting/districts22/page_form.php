...
<input type="hidden" size="69" id="lng" value="<?php if(isset($page['placeLon'])) echo $page['placeLon']; ?>" name="lng"  > 
                    ...
                    <div class="form-group">
                      ...
                      <select class="width_size form-control validate[required]" name="countryId" id="countryId" onchange="$('#city_Load').load( '<?= base_url('admin/generalsetting/get_cities/') ?>/'+$(this).val());" > 
