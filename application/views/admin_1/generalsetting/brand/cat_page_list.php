            ...
            <div class="col-xs-12">
              ...
              <div class="box">
                <div class="box-header">
                  ...
                  <li class=""><a href="<?=base_url('admin/generalsetting/BrandsForm')?>" aria-expanded="false"><?=lang('Add_brand')?></a></li>
                </ul>
                    ...
                    <?php $m=0;foreach($pages as $pages){$m++; ?>    
                      <tr>
                        ...
                        <td><div class="timeline-footer">
                          <a class="btn btn-primary btn-xs" href="<?=base_url('admin/generalsetting/BrandsForm/'.$pages['brandId']); ?>"> 
                          <i class="fa fa-pencil"></i> <?=lang('Edit')?></a>
                         <a class="btn btn-danger btn-xs jConfirmTwo" href="<?=base_url('admin/generalsetting/DeleteBrand/'.$pages['brandId'].'/'.$pages['brandStatus']); ?>" >
