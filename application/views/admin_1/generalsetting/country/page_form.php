          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <div class="box box-warning">
                ...
                <div class="box-body">
<form role="form" action="<?=site_url('admin/Generalsetting/SaveCountry')?>" method="post" name="formID" class="formID" id="formID">
    ...
    data-errormessage="this field is required!"  name="countryCode" id="countryCode" value="<?php if(isset($page['countryCode'])) echo $page['countryCode'] ?>" />
                    ...
                    <div class="form-group">
                     ...
                     <label class="full_width"><?=lang('Currency')?></label>  
                           <select class="width_size form-control validate[required]" name="countryCurrency" id="countryCurrency" onchange="$('#modal2').attr('href','<?=site_url('admin/generalsetting/addCurrency').'/'?>'+this.value)" > 
                         <?php for($z=0;$z<count($currency);$z++){ ?>
                            ...
                            <?php } ?>    
                           </select><a href="<?=site_url('admin/generalsetting/addCurrency')?>"  id="modal"><i class="glyphicon glyphicon-plus" aria-hidden="true"></i></a>
                  <a href="<?=site_url('admin/generalsetting/addCurrency/'.$currency[0]['curr_id'])?>"  id="modal2"><i class="glyphicon glyphicon-pencil" aria-hidden="true"></i></a>
                    </div>
