          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <div class="box box-warning">
                ...
                <div class="box-body">
<form role="form" action="<?=site_url('admin/Passengers/SavePassenger')?>" method="post" name="formID" class="formID" id="formID">
...
<?php } ?>    
    ...
    <div class="form-group">
     ...
     <div class="form-group">
                      ...
                      <select class="width_size form-control validate[required]" name="passengerCountryId" id="passengerCountryId"  onchange="$('#city_Load').load( '<?= site_url('admin/Generalsetting/get_cities/') ?>/'+$(this).val());"> 
	  ...
	  $('#imageContainer').css('display','block');
        ...
        function checkItemUnique(value,mode){
         //   $.ajax({url: '<?= base_url('admin/passengers/checkItemUnique') ?>',type:'POST',cache: false,data: '&val='+value+'&mode='+mode}).done(function(html){$('#HiddenDivLoad').html( html );});
            $('#checkUnique').load('<?= base_url('admin/passengers/checkItemUnique') ?>',{val:value,mode:mode})
        }
	</script>
