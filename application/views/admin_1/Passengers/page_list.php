            ...
            <div class="col-xs-12">
              ...
              <div class="box">
                ...
                <ul class="nav nav-tabs pull-right">
                  <li class=""><a href="<?=base_url('admin/passengers/passengerForm')?>" aria-expanded="false"><?=lang('Add_passenger')?></a></li>
                </ul>
                   ...
                   foreach($pages as $pages){
                      ...
                      <tr>
                        ...
                        <td><div class="timeline-footer">
                          ...
                          <a class="btn btn-primary btn-xs" href="<?=base_url('admin/passengers/passengerForm/'.$pages['passengerId']); ?>"> 
                          <i class="fa fa-pencil"></i> <?=lang('Edit')?></a>
                           
                            <? if($mode==1){?> 
                         <a class="btn btn-danger btn-xs jConfirmTwo" href="<?=base_url('admin/passengers/DeletePassenger/'.$pages['passengerId'].'/'.$pages['passengerActivation']); ?>" >
