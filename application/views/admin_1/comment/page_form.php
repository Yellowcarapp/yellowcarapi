...
-->
                ...
                <div class="box-footer">
                  <div class="pull-right">
                    <a href="<?=site_url('admin/Restaurant/Comments'); ?>" class="btn btn-default"><i class="fa fa-hand-o-left"></i> Back</a>
<!--                    <button class="btn btn-default"><i class="fa fa-share"></i> Forward</button>-->
                  </div>
<a href="<?=site_url('admin/restaurant/DeleteComment/'.$page['com_id']); ?>" class="btn btn-default"><i class="fa fa-trash-o"></i> Delete</a>
...
<a href="<?=site_url('admin/restaurant/SaveComment/'.$page['com_id'].'/'.$value); ?>" class="btn btn-default"> <?=$title?></a>
