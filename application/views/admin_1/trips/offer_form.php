          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <div class="box box-warning">
                ...
                <div class="box-body">
<form role="form" action="<?=site_url('admin/Trips/Saveoffer')?>" method="post" name="formID" class="formID" id="formID">
...
<?php if(isset($page['offerDetails'])) echo $page['offerDetails']; ?>                          
               ...
               <div class="form-group">
                      ...
                      <select class="width_size form-control validate[required]" name="countryId" id="countryId" onchange="$('#city_Load').load( '<?= site_url('admin/generalsetting/get_cities_with_default/') ?>/'+$(this).val());"  > 
