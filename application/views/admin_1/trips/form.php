          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <div class="box box-warning">
                ...
                <div class="box-body">
<form role="form" action="<?=site_url('admin/Trips/SavePricing')?>" method="post" name="formID" class="formID" id="formID">
<input type="hidden" name="pageid" id="pageid" value="<?php if(isset($page['priceId'])) echo $page['priceId'] ?>" />                                
     ...
     <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <select class="width_size form-control validate[required]" name="countryId"   id="countryId" onchange="$('#city_Load').load( '<?= base_url('admin/generalsetting/get_cities/') ?>/'+$(this).val());"  <? if(isset($page['priceId']) && $page['priceId']!=''){?> readOnly<?}?> > 
            ...
            <div class="box-body no-padding">
              ...
              <table class="table table-striped">
                <tbody><tr>
                  ...
                  <th>Level</th>
                  <th>Now Start</th>
                  <th>Min. charge for now</th>
                    <th>Later Start</th>
                  <th>Min. charge for late</th>
                  <th>cost/km</th>
                     <th>cost/minute</th>
                    <th>Waiting cost/hour</th>
                </tr>
...
<script>
    ...
    activate: function( event, ui ) {
        $('#return').load('<?=site_url('admin/trips/getData')?>',{packageId:$('#packageId').val(),countryId:$('#countryId').val(),cityId:$('#cityId').val()})
