...
<a href="<?=site_url('admin/Category/CategoryForm/'.$pages['id']); ?>" class="button icon-pencil">Edit</a>
 <a href="<?=site_url('admin/Category/DeleteCat/'.$pages['id']); ?>"   class="button icon-trash with-tooltip confirm" title="Delete"></a>
