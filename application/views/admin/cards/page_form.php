          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <div class="box box-warning">
                ...
                <div class="box-body">
<form role="form" action="<?=site_url('Cards/SaveCard')?>" method="post" name="formID" class="formID" id="formID">
...
<input type="text" class="form-control width_size" data-validation-engine="validate[required,custom[number]]"
    ...
    data-errormessage="this field is required!" name="cardCredit" id="cardCredit" value="<?php if(isset($page['cardCredit'])) echo floor($page['cardCredit'])  ?>"/>
       ...
       <div class="form-group">
                      ...
                      <select class="width_size form-control validate[required]" name="cardCountry" id="cardCountry" onchange="$('#currency_Load').load( '<?= base_url('generalsetting/get_currency/') ?>/'+$(this).val());" > 
