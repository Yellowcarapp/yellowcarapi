...
<script type="text/javascript" src="http://maps.google.com/maps/api/js?key=AIzaSyD3skdwZe8nXsiFsZQOVGRCCjre74nS7xM&libraries=places"></script>
          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <div class="box box-warning">
                ...
                <div class="box-body">
<form role="form" action="<?=site_url('Generalsetting/Saveplace')?>" method="post" name="formID" class="formID" id="formID">
...
<input type="hidden" size="69" id="lng" value="<?php if(isset($page['placeLon'])) echo $page['placeLon']; ?>" name="lng"  > 
                    ...
                    <div class="form-group">
                      ...
                      <select class="width_size form-control validate[required]" name="countryId" id="countryId" onchange="$('#city_Load').load( '<?= site_url('generalsetting/get_cities/') ?>/'+$(this).val());" > 
