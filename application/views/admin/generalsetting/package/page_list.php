            ...
            <div class="col-xs-12">
              ...
              <div class="box">
                ...
                <ul class="nav nav-tabs pull-right">
                  <li class=""><a href="<?=base_url('generalsetting/packageForm')?>" aria-expanded="false"><?=lang('Add_Packages')?></a></li>
                </ul>
                    ...
                    if($pages['packageId'] > 0)    {
                      ...
                      <tr>
                        ...
                        <td><div class="timeline-footer">
                          ...
                          <a class="btn btn-primary btn-xs" href="<?=base_url('generalsetting/packageForm/'.$pages['packageId']); ?>"> 
                          <i class="fa fa-pencil"></i> <?=lang('Edit')?></a>
                         <a class="btn btn-danger btn-xs jConfirmTwo" href="<?=base_url('generalsetting/Deletepackage/'.$pages['packageId'].'/'.$pages['packageStatus']); ?>" >
