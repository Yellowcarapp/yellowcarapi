    ...
    <body>
        <form method="POST"  onsubmit="return false;">
          ...
          <div class="map_input">
            ...
            <div style="width:20%;display: inline-block;">
                <select class="chosen-select" name="tripNow">
            ...
            <div class="date_trip" style="width:20%;display: inline-block;">
                <input type="date" name="tripDueDate"/>
            </div>
        ...
        <script>
            ...
            function CreateMap2(position)
            {
                ...
                Map_Options2={center: loc2,zoom: 11,mapTypeId: google.maps.MapTypeId.ROADMAP,mapTypeControl: false,zoomControl:true};
