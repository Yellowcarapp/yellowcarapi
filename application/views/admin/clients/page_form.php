...
<a href="<?=base_url('users/DeleteClient/'.$page['user_id']); ?>" class="btn btn-default"><i class="fa fa-trash-o"></i> Delete</a>
<a class="btn btn-default" href="<?=base_url('users/Members'); ?>"> <i class="fa fa-hand-o-left"></i> Back</a>
                  </div>
                  </form>
                </div><!-- /.box-body -->
              </div><!-- /.box -->
