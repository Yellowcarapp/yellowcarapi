                ...
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <?php foreach($pages as $pages){ ?>    
                      ...
                      <a class="btn btn-primary btn-xs" href="<?=base_url('users/MemberDetails/'.$pages['user_id']); ?>"> 
                          <i class="fa fa-pencil"></i> View</a>
                    <a class="btn btn-danger btn-xs jConfirmTwo" href="<?=base_url('users/DeleteClient/'.$pages['user_id']); ?>" >
