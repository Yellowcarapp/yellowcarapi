  ...
  <body class="login-page">
    <div class="login-box">
      ...
      <? $url = explode('/',$_SERVER['REQUEST_URI']);
	 		...
	 		?>
      <button class="btn btn-default lang_btn" onclick="$('#returnSpan').load('<?=base_url()?>admin/switchLanguage',{language:'<?=lang('slang')?>'})">
      <?=lang('xlangauge')?>
      </button>
...
<label class="control-label" for="inputError" id="username_error"><i class="fa fa-times-circle-o"></i> <span id="username_error_message"></span> </label>        
       ...
       <a href="#" class="for_psw" ><?=lang('forgot_password')?></a>
        ...
        <form method="post" action="" id="form-password" class="input-wrapper blue-gradient glossy" title="">
        <div class="form-group has-error error_msg">
        <label class="control-label" for="inputError" id="email_error"><i class="fa fa-times-circle-o"></i> 
            <span id="email_error_message"></span> </label>        
        </div> 
            
          <div class="form-group has-feedback">
            <input type="text" name="mail" id="mail" class="form-control" placeholder="Email Address"/>
          ...
          <div class="lodin_btn">
              <button type="submit" class="btn btn-block log_btn" id="send-password">SendEmail</button>
                        
          </div>
          
        </form>
             <a href="#" class="for_psw" id="login_btn">Login</a><br>
          </div>  
		...
		$(document).ready(function()
		{
			...
			$('#form-password').submit(function(event)
			{
				...
				//	formWrapper.clearMessages();
					 ...
					 */
					 var url=encodeURI('<?=base_url() ?>Users/sendAdminPassword');
 					  $.ajax(url,
                            { method:'POST',
					  		data: {
					  			username:	mail
					  		...
					  		,success: function(data)
					  		{
					  			...
					  			{  
					  				...
					  				alert('thank you message send to your email');
					  				//alert('aa');
