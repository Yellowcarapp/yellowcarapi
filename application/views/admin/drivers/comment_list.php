        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            <li><a href="<?=base_url()?>"><i class="fa fa-dashboard"></i> <?=lang('DashBoard')?></a></li>
               <li><a href="<?=site_url('Drivers/driverList')?>"><i class="fa fa-dashboard"></i> <?=lang('Drivers')?></a></li>
                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <?php $n=0;foreach($pages as $pages){$n++; ?>    
                      ...
                      <!--  <td><div class="timeline-footer">
                          <a class="btn btn-primary btn-xs" href="<?=base_url('drivers/driverForm/'.$pages['tripId']); ?>"> 
