                    ...
                    <?php foreach($pages as $pages){ ?>    
                      <tr>
                        ...
                        <td><div class="timeline-footer">
                          ...
                          <a class="btn btn-primary btn-xs" href="<?=base_url('restaurant/CommentDetails/'.$pages['com_id']); ?>"> 
                          <i class="fa fa-pencil"></i> View</a>
                            <? }?>
                              <? if(in_array(-1,$priv) || in_array(92,$priv)){?> 
                         <a class="btn btn-danger btn-xs jConfirmTwo" href="<?=base_url('restaurant/DeleteComment/'.$pages['com_id']); ?>" >
