            ...
            <div class="col-xs-12">
              ...
              <div class="box">
                ...
                <ul class="nav nav-tabs pull-right">
                  <li class=""><a href="<?=base_url('trips/offerForm')?>"  aria-expanded="false"><?=lang('Add_offer')?></a></li>
                </ul>
                    ...
                    <?php $n=0;foreach($pages as $pages){$n++; ?>    
                      <tr>
                        ...
                        <td><div class="timeline-footer">
                          <a class="btn btn-primary btn-xs" href="<?=base_url('trips/offerForm/'.$pages['offerId']); ?>"> 
                          <i class="fa fa-pencil"></i> <?=lang('Edit')?></a>
                         <a class="btn btn-danger btn-xs jConfirmTwo" href="<?=base_url('trips/Deleteoffer/'.$pages['offerId']); ?>" >
