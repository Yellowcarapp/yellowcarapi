            ...
            <div class="col-xs-12">
              ...
              <div class="box">
                ...
                <ul class="nav nav-tabs pull-right">
                  <li class=""><a href="<?=base_url('trips/pricingForm')?>"  aria-expanded="false"><?=lang('Add_pricing')?></a></li>
                </ul>
                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <!--  <td><?=$pages['typeName_'.lang('db')]?></td>
                        ...
                        <td><div class="timeline-footer">
                          <a class="btn btn-primary btn-xs" href="<?=base_url('trips/pricingForm/'.$pages['priceId']); ?>"> 
                          <i class="fa fa-pencil"></i> <?=lang('Edit')?></a>
                         <a class="btn btn-danger btn-xs jConfirmTwo" href="<?=base_url('trips/delete/'.$pages['priceId']); ?>" >
