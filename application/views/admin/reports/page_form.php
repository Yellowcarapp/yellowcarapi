          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <div class="box box-warning">
                ...
                <div class="box-body">
<form role="form" action="<?= site_url('Reports/printPdfReport') ?>" method="post" name="formID" class="formID" id="formID">
...
<input type="checkbox" name="driverCol" id="driverCol" value="1"  checked /> <?=lang('Drivers')?>
                        ...
                        <div class="checkbox">
                        <label>
<input type="checkbox" name="netWorkCol" id="netWorkCol" value="1"  checked /> <?=lang('Network')?>
...
<script>
  $().ready(function(){
        ...
        if(val==1)//Total
            {
             $('#RepColsH').css('display','none'); 
                ...
                $('#GroupingColsH').css('display','block');//.removeAttr('disabled');
                 $('#GroupingCols').css('display','block');
                $('#exportChart').removeAttr('disabled');
                
            }else{//detai
                $('#GroupingColsH').css('display','none'); //.attr('disabled',true);  
                $('#GroupingCols').css('display','none');
    ...
    {//$('#rep_type').val()$('#tripNow').val()$('#trippromo').val()
        ...
        if(exportType==0)
            {
                var url='<?= site_url('Reports/printReport') ?>';
                var div='reportDiv';
            }else if(exportType==1)
                {
                    var url='<?= site_url('Rreports/printPdfReport') ?>';
                    var div=''; 
                }
        else if(exportType==2)
                {
                    var url='<?= site_url('Reports/printChartReport') ?>';
        ...
        var data={'rep_type':$("input[name=rep_type]:checked").val()
                                                                             ...
                                                                             ,'dist_to':$('#dist_to').val()
                                                                       ,'netWorkCol':$("input[name=netWorkCol]:checked").val()
