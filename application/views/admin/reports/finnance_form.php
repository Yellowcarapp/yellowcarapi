          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <div class="box box-warning">
                ...
                <div class="box-body">
<form role="form" action="<?= site_url('Reports/printFPdfReport') ?>" method="post" name="formID" class="formID" id="formID">
       ...
       <center class="form-group two_radio">
            ...
            <div class="form-group col-md-4" id="Div_0">
                ...
                <input type="text" class="form-control"  name="country" id="country"  />
                    ...
                    <div class="form-group col-md-4" id="Div_1">
                          <label><?=lang('City')?>:</label>
                      <span id="city_Load">
                                        <input class="form-control" type="text"  name="cityId" id="cityId"  /></span>

                        </div>
                         <div class="form-group col-md-4" id="Div_2">
                          <label><?=lang('Levels')?>:</label>
                             <input class="form-control" type="text"  name="level" id="level"  />
                     
                        </div>
                        <div class="form-group col-md-4" id="Div_3">
                          <label><?=lang('Network')?>:</label>
                              <input class="form-control" type="text"  name="network" id="network"  />
                        <!--  <select class="form-control" name="network" id="network" onchange="$('#driversDiv').load('<?=site_url('reports/reloadDrivers')?>',{id:this.value})" >
                         ...
                         <div class="form-group col-md-4" id="Div_4">
                      ...
                      <div class="form-group  col-md-4" id="Div_5">
                    ...
                    <div class="form-group  col-md-4" id="Div_6">
    ...
    <div class="form-group col-md-4" id="Div_7">
     ...
     <div class="form-group col-md-4" id="Div_8" style="height:50px;"> 
   ...
   <select  class="form-control pay_method" name="paymethod" id="paymethod" style="width:65%; float:left;" >
                   ...
                   <div class="form-group  col-md-4" id="Div_9">
                     ...
                     <div class="form-group  col-md-4" id="Div_10">
                        ...
                        <input type="number" name="dist_to" class="form-control" id="dist_to" value="0">
                          ...
                          <!--------- Grouping ---------->
                           ...
                           <div id="GroupingCols" >
                                  ...
                                  <div class="form-group col-md-2" id="grp_0">
...
<input type="radio" name="grCol" id="CountryrGrp" value="1"    checked /> <?=lang('Country')?>
                                  ...
                                  <div class="form-group col-md-2" id="grp_1">
...
<input type="radio" name="grCol" id="CityGrp" value="2"     /> <?=lang('City')?>
                                  ...
                                  <div class="form-group col-md-2" id="grp_2">
...
<input type="radio" name="grCol" id="DriversGrp" value="3"     /> <?=lang('Drivers')?>
                                  ...
                                  <div class="form-group col-md-2" id="grp_3">
...
<input type="radio" name="grCol" id="NetworkGrp" value="4"    /> <?=lang('Network')?>
                                 ...
                                 <div class="form-group col-md-2" id="grp_4"> 
...
<input type="radio" name="grCol" id="PassengersGrp" value="5"    /> <?=lang('Passengers')?>
                                  ...
                                  <div class="form-group col-md-2" id="grp_5">
...
<input type="radio" name="grCol" id="DateGrp" value="6"    /> <?=lang('Date')?>
                               ...
                               <div class="form-group col-md-2" id="grp_6">
...
<input type="radio" name="grCol" id="tripTypeGrp" value="7"    /> <?=lang('Trip_Type')?>
                                  ...
                                  <div class="form-group col-md-2" id="grp_7">
...
<input type="radio" name="grCol" id="stsGrp" value="8"    /> <?=lang('Status')?>
                          ...
                          <!--------- Columns ---------->
                           ...
                           <div id="RepCols" >
                                <div class="form-group col-md-2" id="col_0">
...
<input type="checkbox" name="passengerCol" id="passengerCol" value="1"  onclick="return false;"  checked /> <?=lang('Passengers')?>
                                  ...
                                  <div class="form-group col-md-2" id="col_1">
...
<input type="checkbox" name="driverCol" id="driverCol" value="1"  checked /> <?=lang('Drivers')?>
                                  ...
                                  <div class="form-group col-md-2" id="col_2">
...
<input type="checkbox" name="Total_PriceCol" id="Total_PriceCol" value="1" checked   /> <?=lang('Total_Price')?>
                                  ...
                                  <div class="form-group col-md-2" id="col_3">
...
<input type="checkbox" name="DateCol" id="DateCol" value="1"  checked /> <?=lang('Date')?>
                                  ...
                                  <div class="form-group col-md-2" id="col_4">
...
<input type="checkbox" name="StatusCol" id="StatusCol" value="1"  checked /> <?=lang('Status')?>
                                  ...
                                  <div class="form-group col-md-2" id="col_5">
...
<script>
  $().ready(function(){
          //*************************************************//
            ...
            $('#country').tokenInput("<?=site_url('reports/getCountry')?>", {
               hintText:'<?=lang('Country')?>'
                ,theme: "facebook"
                ,preventDuplicates: true
               , onAdd: function (item) {
                   reloadCity($('#country').val())
               /* $('#cityId').tokenInput("<?=site_url('reports/getCity')?>/"+$('#country').val(), {
               hintText:'<?=lang('City')?>'
                ,theme: "facebook"
                ,preventDuplicates: true
              });*/
      ...
      //***************************************************//
        $('#cityId').tokenInput("<?=site_url('reports/getCity')?>", {
               hintText:'<?=lang('City')?>'
                ,theme: "facebook"
                ,preventDuplicates: true
              });
    ...
    //***************************************************************//
     $('#level').tokenInput("<?=site_url('reports/getLevel')?>", {
               hintText:'<?=lang('level')?>'
                ,theme: "facebook"
                ,preventDuplicates: true
              });
      //************************************************************//
         $('#network').tokenInput("<?=site_url('reports/getnetwork')?>", {
      ...
      //**************************************************************//
       $('#driver').tokenInput("<?=site_url('reports/getDriver')?>", {
               hintText:'<?=lang('Drivers')?>'
                ,theme: "facebook"
                ,preventDuplicates: true
              });
      //*********************************************************//
       $('#trip_type').tokenInput("<?=site_url('reports/getTripType')?>", {
               hintText:'<?=lang('Trip_Type')?>'
                ,theme: "facebook"
                ,preventDuplicates: true
              });
      //***************************************************************************//
        $('#passenger').tokenInput("<?=site_url('reports/getpassenger')?>", {
    ...
    {
        $('#driversDiv').load('<?=site_url('reports/driver_reload')?>',{network:val})
    }
    //****************************************************//
     function reloadCity(val)
    {
        $('#city_Load').load('<?=site_url('reports/citry_reload')?>',{country:val})
    }
    //******************************************************//
    ...
    //***************************************//
    function showHideInputs(mode)
    {
        if(mode==0)
            {
                for(var i=0;i<=14;i++)$('#Div_'+i).css('display','block')
                  for(var i=0;i<=7;i++)$('#grp_'+i).css('display','block')
            ...
            //********************
                    ...
                    }else $('#grp_'+i).css('display','none');

                }
                     $('input[name="grCol"][value="3"]').prop('checked', true); 
            //***********************
        }
    }
    //**************************************//
    extractReport=function()
    {
        ...
        if(exportType==0)
            {
                var url='<?= site_url('reports/printFReport') ?>';
                var div='reportDiv';
            }else if(exportType==1)
                {
                    var url='<?= site_url('Reports/printFPdfReport') ?>';
                    var div=''; 
                }
        else if(exportType==2)
                {
                    var url='<?= site_url('Reports/printFChartReport') ?>';
        ...
        var data={'rep_type':$("input[name=rep_type]:checked").val()
                                                                             ...
                                                                             ,'dist_to':$('#dist_to').val()
                                                                           /*  ,'CountryrGrp':$("input[name=CountryrGrp]:checked").val()
                                                                             ,'CityGrp':$("input[name=CityGrp]:checked").val()
                                                                             ,'DriversGrp':$("input[name=DriversGrp]:checked").val()
                                                                             ,'NetworkGrp':$("input[name=NetworkGrp]:checked").val()
                                                                             ,'PassengersGrp':$("input[name=PassengersGrp]:checked").val()
                                                                             ,'DateGrp':$("input[name=DateGrp]:checked").val()
                                                                             ,'tripTypeGrp':$("input[name=tripTypeGrp]:checked").val()
                                                                             ,'stsGrp':$("input[name=stsGrp]:checked").val()*/
        ...
        $('#'+div).load(url,data);
                ...
                $( "#formID" ).submit();
             /*  $.post(url,{'rep_type':$("input[name=rep_type]:checked").val()
                                                                             ,'exportType':$("input[name=exportType]:checked").val()
                                                                             ,'offerRange':$('#offerRange').val()
                                                                             ,'country':$('#country').val()
                                                                             ,'cityId':$('#cityId').val()
        ...
        $( "#formIDx" ).submit(function( event ) {
          ...
          //  if($('#socialEditForm')[0].checkValidity())
            ...
            console.log($('#rep_type').val());
                $.post('<?= site_url('Reports/printReport') ?>', $( "#formID" ).serialize() ).done(function(data) {
