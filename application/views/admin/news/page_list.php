            ...
            <div class="col-xs-12">
              ...
              <div class="box">
                <div class="box-header">
                  ...
                  <li class=""><a href="<?=base_url('news/NewsForm')?>" aria-expanded="false"><?=lang('Add_News')?></a></li>
                </ul>
                    ...
                    <?php $m=0;foreach($pages as $pages){$m++; ?>    
                      <tr>
                        ...
                        <td><div class="timeline-footer">
                          <a class="btn btn-primary btn-xs" href="<?=base_url('news/NewsForm/'.$pages['newsId']); ?>"> 
                          <i class="fa fa-pencil"></i> <?=lang('Edit')?></a>
                         <a class="btn btn-danger btn-xs jConfirmTwo" href="<?=base_url('news/DeleteNews/'.$pages['newsId']); ?>" >
