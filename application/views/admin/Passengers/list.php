         ...
         <?php foreach($pages as $pages) { ?>       
						...
						<td class="low-padding align-center">
                        	<span class="button-group compact">
								<a href="<?=site_url('Users/Form/'.$pages['id']); ?>" class="button icon-pencil">تعديل</a>
							
							<?php if($pages['id']>1) { ?>
 								<a href="<?=site_url('Users/delete/'.$pages['id']); ?>"   class="button icon-trash with-tooltip confirm" title="حذف"></a>
 							<?php } ?>
 							</span>
                      </td>
