...
<a href="<?=site_url('Category/FeaturePagesForm/'.$pages['id']); ?>" class="button icon-pencil">Edit</a>
 <a href="<?=site_url('Category/DeleteFeaturePages/'.$pages['id']); ?>"   class="button icon-trash with-tooltip confirm" title="Delete"></a>
