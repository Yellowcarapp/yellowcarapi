					...
					<tr>
						...
						<td class="low-padding align-center">
                        	<span class="button-group compact"> 
                        	   <a href="<?=site_url('Members/CatForm/'.$pages['id']); ?>" class="button icon-pencil">Edit</a>
  
								<a href="<?=site_url('Members/DeleteCat/'.$pages['id']); ?>"   class="button icon-trash with-tooltip confirm" title="Delete"></a>
 							</span>
                      </td>
