  ...
  var methods = { 
    init : function( options ) { 
      ...
      var settings = $.extend( {
       ...
       'ajaxURL'            : site_url+'themes?', //URL to make ajax requests to for filtered results. Defaults to current URL.
       ...
       'hash'               : false, //whether or not to put facet values in url after hashtag #
