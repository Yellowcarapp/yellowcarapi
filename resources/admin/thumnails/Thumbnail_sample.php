...
$thumb=new Thumbnail($_REQUEST['image']);	        // Contructor and set source image file
...
$thumb->save("imagenewName.".$thumb->output_format ,'');			// save your thumbnail to file, or ,path
