...
class FileUpload {
    ...
    private $fileExtension = "png|jpg|jpeg|gif";               // File extension of uploaded file
    ...
    public $allowedExtensions = "png|jpg|jpeg|gif";            // Array of permitted file extensions
    ...
    function __construct($uploadName = null) {
        ...
        if ($this->fileName) {
            ...
            $this->fileName = str_replace(array('/','\\'),'_',md5(time()).".".$this->fileExtension);
